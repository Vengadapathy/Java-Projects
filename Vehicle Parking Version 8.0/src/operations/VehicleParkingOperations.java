...
//			ex1.printStackTrace();
			System.out.println("Exceptional Case occured");
		}finally {
				try {
	...
	private void adminLogin() {
			...
			System.out.println("5.Employee list for more than one vehicles parked");
			System.out.println("6.Vehicle Parking List group by Employees and Date of Parking");
			...
			case FOUR:
				...
				break;
			case FIVE:
				getManyEmployeeVehiclesParkingList();
				break;
			case SIX:
				getEmployeeGroupedParkingList();
				break;
			case SEVEN:	
	...
	public void getManyEmployeeVehiclesParkingList() {
		database.getMoreEmployeeParkings();
	}
	public void getEmployeeGroupedParkingList() {
		database.getEmployeeGroupedParkingList();
	}
}
