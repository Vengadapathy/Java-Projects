...
public class ATM_Machine_Class extends ATM_Operations {
	...
	public AtmCard userAccount(long cardNo,int pin) {
		System.out.println("2    "+ cardNo+"   "+pin);
	...
	public boolean transaction(Account fromAccount,long toAccount,int process, String type, double amount) {
...
//				throw new InsufficientAmountException();
	...
	public int generateOtp() {
		Integer val = (new Random().nextInt(899999)) + 100000;
		return val;
	}
